/**
 * quiz-data.js — BookWardens-Lean
 * TheBookWardens QuizData.js를 window 전역으로 변환
 */
window.vocabList = [
    {
        word: "Luminous",
    ...
    },
    {
        ...
        options: ["A. Strange or odd", "B. Common and boring", "C. Sudden and fast"],
        answer: 0,
    ...
    },
    {
        ...
        options: ["A. To appear suddenly", "B. To disappear completely", "C. To become brighter"],
        answer: 1,
        image: "./rune_vanish.png"
    }
];

window.midBossQuizzes = [
